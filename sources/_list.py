...
print(left, middle, right) # a ['b', 'c', 'd'] e
...
lst = ['a', 'b', 'c', 'd', 'e']
[print(el, end=', ') for el in lst] # a, b, c, d, e, 
print()
...
# If the amount of elements to change is more then the range, these will be inserted in the list
lst = ['a', 'b', 'c']
lst[1:2] = ['d', 'e']
print(lst) # ['a', 'd', 'e', 'c'] 
