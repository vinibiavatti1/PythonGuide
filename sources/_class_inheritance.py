...
class Client4(Person):
    pass
# print(Client4.version) # AttributeError: type object 'Client4' has no attribute 'version'
...
class Client8(Person4):
    def __init__(self, name):
        super().__init__(name) # super without parameters means super(Client8, self)
client = Client8('Vini')
print(client.name) # Vini
