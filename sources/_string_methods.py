...
t1 = '  Hello world  '
print(t1.lstrip()) # Hello world  (EOF)

# rstrip([chars])
# Returns a right trim version of the string from right
t1 = '  Hello world  '
print(t1.rstrip()) #   Hello world
...
text = 'Hello\tworld'
print(text.expandtabs(10)) # Hello     world
...
# index(sub, start, end)
# Searches the string for a specified value and returns the position of where it was found
# This is similar to find(), but when the string is not found, it will raise an error
text = 'Hello world'
...
comma = ', '
print(comma.join(fruits)) # Apple, Orange, Pineaple

# ljust(width, [fillchar])
# Returns a left justified version of the string
text = 'Hello'
print(text.ljust(10, 'o')) # Helloooooo
...
print(text.rfind('casa')) # 12

# rindex(sub, [start], [end])
# Searches the string from right for a specified value and returns the last position of where it was found
# This is similar to rfind(), but when the string is not found, it will raise an error
text = 'Mi casa, su casa'
...
print(text.title()) # The Da Vinci Code
...
print(text.translate(dictionary)) # hellooe
