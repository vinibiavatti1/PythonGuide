...
st = {'a', 'b', 'c', 'd', 'e'}
{print(el, end=', ') for el in st} # a, b, c, d, e, 
print()
...
# The data on set cant be changed because it is unordered. To make changes, the right way is to
# remove the element and add the other one
st = {'a', 'b', 'c'}
st.remove('a')
st.add('d')
print(st) # {'d', 'b', 'c'}
