...
# fromkeys(keys, [value])
# Returns a dictionary with the specified keys with the specified value or None
# if no value was informed
dct1 = {}
...
# Returns the value of the specified key. If the key does not exist: insert the
